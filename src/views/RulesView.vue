  ...
  <main class="app-shell">
    ...
    <section class="panel">
      ...
      <div class="formula-box">
        <div class="formula-main">
          2026-Q2 起：最終業績獎金 ＝ Σ（案件未連稅金額 × 基礎%）× 業績火箭 × 回購倍率 × 客單價倍率 ×
          成材率倍率
        </div>
        <p class="hint" style="margin-top: 12px; margin-bottom: 0">
          2026-Q1 及更早：最終獎金 ＝ 案件未連稅金額 × 3.5%（不分客戶類型、不套四倍率）。
        </p>
        <p class="hint" style="margin-top: 8px; margin-bottom: 0">
          新制下每個案子先按客戶類型算「基礎獎金」，整季加總後再乘上四個季度倍率。
        </p>
      </div>
    </section>
    ...
    <section class="panel">
      ...
      <ul class="rules-list">
        ...
        <li>
          倍率自 2026-Q2 起適用；在此之前的季度（含 2026-Q1）固定 3.5%、不套用四倍率。
        </li>
